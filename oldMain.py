...
class App(Tk):
	def __init__(self):
		...
		self.board.bind("<Button-4>",lambda *_,zoom_status="in":self.zoom(*_,zoom_status))
		self.board.bind("<Button-5>",lambda *_,zoom_status="out":self.zoom(*_,zoom_status))
	...
	def add_node_row(self):
		...
		varx.trace("w",lambda *_,name=name,varx=varx,vary=vary: self.draw_node(name,varx,vary))
		vary.trace("w",lambda *_,name=name,varx=varx,vary=vary: self.draw_node(name,varx,vary))
